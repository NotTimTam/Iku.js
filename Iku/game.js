...
class Solid extends Behaviour {
   ...
   * @param {boolean} overwriteSizing - Whether or not to overwrite the sprite's width and height with the bounding boxes width and height + offsets.
   */
  constructor(
    sprite,
    xOffset,
    ...
    width,
    height,
    overwriteSizing = false
  ) {
    // Apply all general behaviour settings.
    super(sprite, "Solid");

    if (overwriteSizing) {
      sprite.width = width + xOffset;
      sprite.height = height + yOffset;
    }
